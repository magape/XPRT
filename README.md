...
Because we use the JST XH as battery connector for the [a](https://nonformal.ro/karel) [Karel robotic platform](https://nonformal.ro/karel), I also designed a removal tool for the XH connector.

During some testing the top of one removing tool broke and that's when I realized I could make a puller for both the XH and PH connectors. This is how XPRT came about, which we use for the [b](https;//nonformal.ro/ubot)[uBot robotics platform](https://nonformal.ro/ubot), which has both types of connectors: XH and PH.
